...
> 本 Fork 版本支援繁體中文顯示，於 zh-TW 語系環境自動切換顯示繁體中文 (依 CultureInfo.CurrentCulture.Name 判斷)，其餘語系則顯示簡體中文。提供 Lunar.Util.TextResource.SwitchToCulture(cultureName) 方法強制切換特定語系。(目前僅支援 zh-TW)
